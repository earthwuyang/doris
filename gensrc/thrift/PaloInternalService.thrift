...
struct TPipelineInstanceParams {
  ...
  // Note: Merge new format from GitHub here

  // reserve about 1000 count for other params before fragment_instance_id_human_readable
  // fragment_instance_id_human_readable: only set in explain detail
  1001: optional string fragment_instance_id_human_readable
}
